...
public class MainActivity extends ListActivity {
    ...
    private final class AppListAdapter extends BaseAdapter {
        ...
        public AppListAdapter(Context context) {
            ...
            for (ActivityManager.RunningAppProcessInfo app : ((ActivityManager) getSystemService("activity")).getRunningAppProcesses()) {
            ...
            if (this.mList != null) {
                ...
                Collections.sort(this.mList, sDisplayNameComparator);
